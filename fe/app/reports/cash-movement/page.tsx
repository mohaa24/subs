...
function paginateRows(rows: TableRow[]) {
  ...
  const capacity = (pageIndex: number) => pageIndex === 0 ? 18 : 24;
...
function ReportStyles() {
  return <style jsx global>{`
    ...
    @media print {
      ...
      .cash-report-page { display:flex !important; flex-direction:column; width:281mm; height:194mm; padding:0 !important; overflow:visible !important; break-after:page; page-break-after:always; box-sizing:border-box; }
      .cash-report-page:last-child { break-after:auto; page-break-after:auto; }
      .cash-report-header { display:block !important; flex:none; margin-bottom:3mm !important; }
      .cash-report-header-compact { display:flex !important; }
      ...
      .cash-report-footer { display:flex !important; position:static !important; flex:none; margin-top:auto !important; padding-top:2mm !important; font-size:7.5pt !important; }
    }
  `}</style>;
}
